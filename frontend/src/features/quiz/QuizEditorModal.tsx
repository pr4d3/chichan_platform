...
import { Button, FormRow, Modal, Spinner } from "@/components/ui";
import {
  X,
  Plus,
  Trash,
...
export function QuizEditorModal({
  ...
  return (
    <Modal
      ...
      panelClassName="border border-white/80 flex flex-col"
    >
      <>
        {/* Header */}
        <div className="px-6 py-5 border-b border-outline-variant/30 flex items-center justify-between bg-surface-container-lowest shrink-0">
        ...
        {loading ? (
          ...
          <form
            ...
            className="flex-1 min-h-0 overflow-y-auto p-6 space-y-6 text-xs text-on-surface"
          >
            ...
            <div className="bg-surface-container-lowest p-5 rounded-2xl border border-outline-variant/30 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <FormRow
                  label="Mô tả hoặc hướng dẫn làm bài"
                  className="md:col-span-2"
                >
                  <textarea
                    value={description}
                ...
                <FormRow label="Điểm đạt yêu cầu (Passing score: %)">
                ...
                <div className="p-4 rounded-xl bg-amber-50/70 border border-amber-200/60 md:col-span-2 space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <FormRow
                      label="Số lượt thử tối đa trước khi khóa:"
                      tone="warn"
                    >
                      <div className="flex items-center gap-2">
                        <input
                    ...
                    <FormRow
                      label="Thời gian chờ nếu hết lượt (Cooldown):"
                      tone="warn"
                    >
                      <div className="flex items-center gap-2">
                        <input
            ...
            <div className="space-y-4">
              ...
              {questions.map((q, qIdx) => (
                ...
                >
                  ...
                  {/* Explanation Field */}
                  <FormRow
                    label="Lời giải thích y khoa chi tiết (Hiển thị sau khi nộp bài)"
                    className="pt-1"
                  >
                    <textarea
                      value={q.explanation || ""}
